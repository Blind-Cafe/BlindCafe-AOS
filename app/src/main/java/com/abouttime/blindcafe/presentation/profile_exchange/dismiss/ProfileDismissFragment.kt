...
class ProfileDismissFragment: BaseFragment<ProfileDismissViewModel>(R.layout.fragment_profile_dismiss) {
    override val viewModel: ProfileDismissViewModel by viewModel()
