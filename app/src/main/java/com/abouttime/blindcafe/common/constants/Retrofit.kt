...
object Retrofit {
    ...
    const val GET_MY_PROFILE_IMAGE_URL = "api/user/image"
    ...
    const val POST_ACCEPT_MATCHING_URL = "api/matching/{matchingId}/partner"
    const val DELETE_DISMISS_MATCHING_URL ="api/matching/{matchingId}/partner"
    const val DELETE_PROFILE_IMAGE_URL = "api/user/image"
    const val POST_ENTERING_LOG_URL = "api/matching/{matchingId}/log"
    const val POST_MESSAGE_URL = "api/chat/{matchingId}"
    const val GET_MATCHING_PROFILE = "api/user/{userId}/profile"
